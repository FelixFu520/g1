...
if __name__ == "__main__":
    ...
    parser.add_argument("--duration", type=float, default=None, help="录音时长(秒), 默认 5 秒")
    args = parser.parse_args()

    try:
        record_and_playback(duration=args.duration if args.duration is not None else 1000000000)
